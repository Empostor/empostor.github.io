...
The main server configuration file. See [Server Configuration](../get-started/configuration.md) for the complete reference.
...
The `AuthApi` section controls how Empostor fetches player FriendCodes for identity verification. See [Verification API](../reference/verification-api.md) for the full flow.
...
See [Hello Page](../server/hello-page.md) for more details.
...
See [Writing a Plugin](../develop/writing-a-plugin.md#internationalization-i18n) for code-level plugin i18n with `IPluginLanguageProvider`.
...
Defines the plugins available in the admin panel's Plugin Marketplace. See [Plugin Marketplace](../server/plugin-marketplace.md) for the complete format reference.
