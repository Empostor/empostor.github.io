...
- **Matchmaker（对局）** — 游戏生命周期事件（游戏创建、游戏开始、游戏结束、游戏销毁）
- **Admin（管理）** — 管理/审核事件（玩家封禁、玩家举报）
...
| 键 | 默认值 | 描述 |
| :--- | :--- | :--- |
| **MatchmakerUrl** | `""` | 对局事件的 Discord Webhook URL（游戏创建、游戏开始、游戏结束、游戏销毁）。留空禁用。 |
| **AdminUrl** | `""` | 管理/审核事件的 Discord Webhook URL（玩家封禁、玩家举报）。留空禁用。 |
...
| 事件 | 嵌入颜色 | 字段 |
| :--- | :--- | :--- |
| 游戏创建 | 绿色 | 游戏代码、房主名称、房主好友代码、地图、玩家数量、内鬼数量、备注 |
